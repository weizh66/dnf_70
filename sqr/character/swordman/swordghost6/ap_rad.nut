...
function sq_AddEffect(appendage)
{
	...
	appendage.sq_AddEffectFront("character/gunner/effect/animation/revolvercriticaldamageup/revolver_critical_damage_up1.ani")
	appendage.sq_AddEffectFront("character/gunner/effect/animation/revolvercriticaldamageup/revolver_critical_damage_up2.ani")
...
function proc_appendage_buff_beidong(appendage)
{
	...
	{
		local particleCreater = appendage.getVar().GetparticleCreaterMap("mm_darkaura", "passiveobject/new_skill/at_mage_summon_nutouwang/particle/buff_effect_rad.ptl", obj);
