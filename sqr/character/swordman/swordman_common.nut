...
function procSkill_WUWO(obj)
{
    local skill_level = sq_GetSkillLevel(obj, SKILL_WUWO);
	if(skill_level > 0)
	{
        if (!CNSquirrelAppendage.sq_IsAppendAppendage(obj, "character/swordman/jianshen/ap_wuwo.nut") )
        {
            local appendage = CNSquirrelAppendage.sq_AppendAppendage(obj, obj, SKILL_WUWO, false, 
				"character/swordman/jianshen/ap_wuwo.nut", true);

            appendage.setAppendCauseSkill(BUFF_CAUSE_SKILL, sq_getJob(obj), SKILL_WUWO, skill_level);
            CNSquirrelAppendage.sq_AppendAppendageID(appendage, obj, obj, SKILL_WUWO, true);

			local value0 = sq_GetLevelData(obj, SKILL_WUWO, 0, skill_level); 
			local value1 = sq_GetLevelData(obj, SKILL_WUWO, 1, skill_level); 
			local change_appendage = appendage.sq_getChangeStatus("WUWO");
            ...
            if (change_appendage){
				...
				change_appendage.addParameter(CHANGE_STATUS_TYPE_PHYSICAL_ATTACK, false, value1.tofloat());
			}
...
function procSkill_WUWO33(obj)
{
    local skill_level = sq_GetSkillLevel(obj, SKILL_WUWO33);
	if(skill_level > 0)
	{
        if (!CNSquirrelAppendage.sq_IsAppendAppendage(obj, "character/swordman/jianshen/ap_wuwo33.nut") )
        {
            local appendage = CNSquirrelAppendage.sq_AppendAppendage(obj, obj, SKILL_WUWO33, false, 
				"character/swordman/jianshen/ap_wuwo33.nut", true);

            appendage.setAppendCauseSkill(BUFF_CAUSE_SKILL, sq_getJob(obj), SKILL_WUWO33, skill_level);
            CNSquirrelAppendage.sq_AppendAppendageID(appendage, obj, obj, SKILL_WUWO33, true);

			local value0 = sq_GetLevelData(obj, SKILL_WUWO33, 0, skill_level); 
			local value1 = sq_GetLevelData(obj, SKILL_WUWO33, 1, skill_level); 
			local value2 = sq_GetLevelData(obj, SKILL_WUWO33, 2, skill_level); 
			local value3 = sq_GetLevelData(obj, SKILL_WUWO33, 3, skill_level); 
			local value4 = sq_GetLevelData(obj, SKILL_WUWO33, 4, skill_level); 
			local value5 = sq_GetLevelData(obj, SKILL_WUWO33, 5, skill_level); 
			local value6 = sq_GetLevelData(obj, SKILL_WUWO33, 6, skill_level); 
			local change_appendage = appendage.sq_getChangeStatus("WUWO33");
			if(!change_appendage)
            {
				change_appendage = appendage.sq_AddChangeStatusAppendageID(obj, obj, 0, 
            ...
            if (change_appendage){
				...
				change_appendage.addParameter(CHANGE_STATUS_TYPE_MAGICAL_DEFENSE, false, value4.tofloat());
				change_appendage.addParameter(CHANGE_STATUS_TYPE_HP_MAX, false, value5.tofloat());
				change_appendage.addParameter(CHANGE_STATUS_TYPE_MP_MAX, false, value6.tofloat());
