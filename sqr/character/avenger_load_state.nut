...
CNAvenger.pushState("character/priest/devilfist/devilfist.nut", "DevilFist", 129, 129);
CNAvenger.pushState("character/priest/unholyfury/unholyfury.nut", "UnholyFury", 130, 130);
