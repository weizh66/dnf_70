...
STATE_judekatheeternal				<- 222	// ??? ??
STATE_armageddonstrike				<- 223	// ??? ??
STATE_shardmagnum					<- 224	// ??? ??
STATE_overfreezeextension			<- 225	// ??? ??
STATE_elementalfield				<- 226	// ??? ??
STATE_convergencecannon				<- 227	// ??? ??

SKILL_judekatheeternal				<- 57	// 孺萄 蝶??檜?
SKILL_armageddonstrike				<- 70	// 孺萄 蝶??檜?
SKILL_shardmagnum					<- 250	// 孺萄 蝶??檜?
SKILL_overfreezeextension			<- 249	// 孺萄 蝶??檜?
SKILL_elementalfield				<- 248	// 孺萄 蝶??檜?
SKILL_convergencecannon				<- 247	// 孺萄 蝶??檜?

CUSTOM_ANI_JudekaTheEternal_Cast_Body					<- 97	
CUSTOM_ANI_JudekaTheEternal_Start_Body					<- 98	
CUSTOM_ANI_ArmageddonStrikeStart_Body					<- 99	
CUSTOM_ANI_ArmageddonStrikeCreate_Body					<- 100	
CUSTOM_ANI_ArmageddonStrikeExplosion_Body				<- 101	
CUSTOM_ANI_ShardMagnumBody_Body							<- 102	
CUSTOM_ANI_OverFreezeExtensionCasting					<- 103	
CUSTOM_ANI_OverFreezeExtensionAttack					<- 104	
CUSTOM_ANI_ElementalField								<- 105	
CUSTOM_ANI_ConvergenceCannonStart_Body					<- 106	
CUSTOM_ANI_ConvergenceCannonCreate_Body					<- 107	
CUSTOM_ANI_ConvergenceCannonShot_Body					<- 108	

CUSTOM_ATTACK_INFO_OverFreezeExtension					<- 24	
CUSTOM_ATTACK_INFO_ArmageddonStrike						<- 25	
